...
const DEFAULT_PALETTE: &[&str] = &[
    ...
    "#ff8800", "#8800ff", "#0088ff", "#88ff00", "#ff0088", "#00ff88", "#880000", "#008800",
    "#000088", "#888888", "#444444", "#cccccc", "#ff4444", "#44ff44", "#4444ff", "#ffaa00",
    "#aa00ff", "#00aaff", "#ffcc88", "#88ccff", "#cc88ff", "#88ffcc", "#553300", "#335500",
];
